package systemata.iot.eiot.common.exceptions;

import lombok.AllArgsConstructor;
import lombok.Getter;
import systemata.iot.eiot.common.contracts.domain.IErrorCode;

import java.util.List;
import java.util.stream.Stream;

import static systemata.iot.eiot.common.domain.constants.Global.INITIAL_ERROR_CODE_COMMON;
