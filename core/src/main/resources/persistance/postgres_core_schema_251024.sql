...
values ('12345678-1234-1234-1234-123456789abd', 'admin', 'admin', now(), now(), 'bin. in', true, false, 1, 1, 0, 1);
insert into gate_type (id, created_by, last_modified_by, created_date, last_modified_date, name, is_input, is_extended,
                       protocol_type, max_value, base_value, pin_count)
values ('12345678-1234-1234-1234-123456789abe', 'admin', 'admin', now(), now(), 'bin. out', false, false, 1, 1, 0, 1);
